...
//     try{
//         const {description,title,timeDuration,sectionID}=req.body;
...
//         if(!subSectionID || !description || !title || !timeDuration){
//             return res.status(400).json({error:"Please fill all the fields"});
//         }
//         const existingSubSection=await SubSection.findById(subSectionID);
//         if(!existingSubSection){
//             return res.status(400).json({error:"SubSection does not exist"});
//         }
//         const subSection=await SubSection.findByIdAndUpdate(subSectionID,{description:description,title:title,timeDuration:timeDuration},{new:true});
